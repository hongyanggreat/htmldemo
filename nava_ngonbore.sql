...
CREATE TABLE `auction` (
  ...
  `started_price` double NOT NULL DEFAULT '0',
  `ended_price` double NOT NULL DEFAULT '0',
  `step_price` double NOT NULL DEFAULT '0',
  `bot_stop_price` double NOT NULL DEFAULT '0',
...
CREATE TABLE `auction_order` (
  ...
  `status` enum('draft','submitted','cancelled','shipping','completed','paid') NOT NULL,
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(19, 'Nam Từ Liêm', 'Huyện', '21 02 39N, 105 45 32E', 1),
(20, 'Thanh Trì', 'Huyện', '20 56 32N, 105 50 55E', 1),
(21, 'Bắc Từ Liêm', 'Huyện', '21 02 39N, 105 45 32E', 1),
...
--
-- Table structure for table `eav_attribute_rules`
--
...
(1, 'Điện thoại', 'common\\models\\Product', 1);
...
INSERT INTO `email_message` (`id`, `status`, `priority`, `from`, `to`, `subject`, `text`, `created_at`, `sent_at`, `bcc`, `files`) VALUES
(1, 0, 0, NULL, 'phuong17889@gmail.com', '!!! UNKNOWN TEMPLATE  !!!', '!!! UNKNOWN TEMPLATE  !!!', 1522061672, NULL, NULL, NULL);
...
('m000000_000000_base', 1521014131),
('m000000_000001_banner', 1521802248),
('m000000_000002_category', 1522049809),
('m000000_000003_province', 1521802248),
('m000000_000004_district', 1521802248),
('m000000_000004_district_data', 1521802248),
('m000000_000005_page', 1521802248),
('m000000_000006_eav_entity', 1521802248),
('m000000_000007_eav_attribute', 1521802248),
('m000000_000008_eav_attribute_type', 1521802248),
('m000000_000009_eav_attribute_rules', 1521802248),
('m000000_000010_eav_attribute_option', 1521802248),
('m000000_000011_eav_attribute_value', 1521802248),
('m000000_000012_email_message', 1521802248),
('m000000_000013_email_template', 1521802248),
('m000000_000014_user', 1521802248),
('m000000_000015_user_address', 1521802248),
('m000000_000016_social_account', 1521802248),
('m000000_000017_profile', 1521802248),
('m000000_000018_token', 1521802248),
('m000000_000019_role', 1521802248),
('m000000_000020_slider', 1521802248),
('m000000_000021_product', 1521802248),
('m000000_000022_product_auction_proposal', 1521802248),
('m000000_000023_product_detail', 1521802248),
('m000000_000024_product_images', 1521802248),
('m000000_000025_order', 1521802248),
('m000000_000026_order_detail', 1521802248),
('m000000_000027_auction', 1521802248),
('m000000_000028_auction_history', 1521802248),
('m000000_000029_auction_order', 1521802248),
('m000000_000030_Relations', 1521802248),
('m180326_081212_phone_verify', 1522052021);
...
CREATE TABLE `order` (
  ...
  `user_address_id` int(11) DEFAULT NULL,
  `total_amount` double NOT NULL DEFAULT '0',
  `status` enum('draft','submitted','cancelled','shipping','completed','paid') NOT NULL DEFAULT 'draft',
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `phone_verify` (
  ...
  `status` enum('new','used','expired','draft') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'draft',
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `product` (
  ...
  `origin` varchar(255) NOT NULL COMMENT 'xuất xứ',
...
--
-- Table structure for table `product_auction_proposal`
--

CREATE TABLE `product_auction_proposal` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `created_at` int(11) DEFAULT NULL
...
CREATE TABLE `product_detail` (
  `id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `attribute_values` text COMMENT 'mảng json chứa các id của bảng attribute_value',
...
INSERT INTO `profile` (`user_id`, `name`, `public_email`, `gravatar_email`, `gravatar_id`, `location`, `website`, `bio`, `timezone`, `phone`, `avatar`) VALUES
(1, 'Le Phuong', 'phuong17889@gmail.com', 'phuong17889@gmail.com', '139c097dbdede62de12856b10b9eba05', NULL, NULL, NULL, NULL, '0989489969', NULL),
(2, 'Le Phuong', 'phuong17889@gmail.com', 'phuong17889@gmail.com', '139c097dbdede62de12856b10b9eba05', NULL, NULL, NULL, NULL, '0989489969', NULL);
...
CREATE TABLE `setting` (
  ...
  `store_range` text COLLATE utf8_unicode_ci,
...
INSERT INTO `setting` (`id`, `parent_id`, `code`, `name`, `desc`, `type`, `store_range`, `store_dir`, `value`, `sort_order`, `store_url`, `icon`) VALUES
(19, 0, 'general', 'Tổng quan', '', 'group', '', '', '', 1, '', 'glyphicon-home'),
(21, 19, 'general_site_title', 'Tiêu đề trang', '', 'text', '', '', 'Ngon Bổ Rẻ', 1, '', ''),
(22, 45, 'phone_verify_expire', 'Hết hạn xác nhận', 'Thời gian hết hạn xác nhận thông qua tin nhắn điện thoại tính bằng giây', 'number', '', '', '600', 3, '', ''),
(23, 45, 'phone_verify_time_between', 'Thời gian gửi lại', 'Thời gian có thể yêu cầu tin nhắn xác nhận mới', 'number', '', '', '60', 4, '', ''),
(24, 45, 'phone_verify_content', 'Nội dung tin nhắn xác nhận', 'Hỗ trợ tham số: {{code}}', 'textarea', '', '', 'Ma xac nhan tai ngonbore.vn cua ban la: {{code}}', 5, '', ''),
(25, 19, 'general_site_description', 'Chú thích trang', '', 'textarea', '', '', '', 2, '', ''),
(27, 19, 'general_hr_1', 'general hr 1', '', 'separator', '', '', '', 7, '', ''),
(28, 19, 'general_maintenance', 'Đóng cửa bảo trì', '', 'radio', '{\"Không\":\"Không\",\"Có\":\"Có\"}', '', 'Không', 8, '', ''),
(29, 19, 'general_maintenance_content', 'Nội dung bảo trì', '', 'roxymce', '', '', '<p>This is a paragraph</p>', 9, '', ''),
(30, 0, 'social', 'Mạng xã hội', '', 'group', '', '', '', 2, '', 'glyphicon-link'),
(31, 30, 'facebook_connect', 'Đăng nhập bằng Facebook', '', 'radio', '{\"Không\":\"Không\",\"Có\":\"Có\"}', '', 'Có', 4, '', ''),
(32, 30, 'facebook_client_id', 'Facebook Client ID', '', 'text', 'ab,1,cd,2,3,4,de,ef,gh,7,8', '', '1228859627247630', 5, NULL, ''),
(33, 30, 'facebook_client_secret', 'Facebook Client secret', '', 'text', '', '@app/web/uploads', '4cec8794d221d4f50876455faadd5a9b', 6, NULL, ''),
(34, 30, 'social_hr_1', 'Social hr 1', '', 'separator', '', '@app/web/uploads', 'footer-top-logo.png', 7, NULL, ''),
(35, 30, 'google_connect', 'Đăng nhập bằng Google', '', 'radio', '{\"Không\":\"Không\",\"Có\":\"Có\"}', '', 'Có', 8, '', ''),
(36, 30, 'google_client_id', 'Google Client ID', '', 'text', 'no,yes', '', '1021311944010-cscn0ummod782u8mt45vpnc2gm5fobph.apps.googleusercontent.com', 9, NULL, ''),
(37, 30, 'google_client_secret', 'Google Client secret', '', 'text', '1,2,3,abc,4,def,5,6', '', 'GinItpSafzoEJZrfHTKYfJlu', 10, NULL, ''),
(39, 0, 'smtp', 'Cấu hình hộp thư', '', 'group', '', '', '', 3, '', 'glyphicon-envelope'),
(40, 39, 'smtp_host', 'SMTP Host', '', 'text', '', '', '', 1, '', ''),
(41, 39, 'smtp_user', 'SMTP Username', '', 'text', '', '', '', 2, '', ''),
(42, 39, 'smtp_password', 'SMTP Password', '', 'text', '', '', '', 3, '', ''),
(43, 39, 'smtp_port', 'SMTP Port', '', 'number', '', '', '', 4, '', ''),
(44, 39, 'smtp_encryption', 'SMTP Encryption', '', 'radio', '{\"none\":\"None\",\"ssl\":\"SSL\",\"tls\":\"TLS\"}', '', 'tls', 5, '', ''),
(45, 0, 'phone_verify', 'Xác minh điện thoại', '', 'group', '', '', '', 4, '', 'glyphicon-earphone'),
(46, 45, 'phone_verify_access_token', 'SpeedSMS Access Token', 'Đăng ký tài khoản và nạp tiền tại speedsms.vn', 'text', '', '', '_ygG-h4PW6KuA6q8_yWUwwVPcc3EFXug', 1, '', ''),
(47, 45, 'phone_verify_hr_1', 'phone_verify_hr_1', '', 'separator', '', '', '', 2, '', ''),
(48, 30, 'social_facebook_url', 'Liên kết đến trang Facebook', '', 'text', '', '', '', 1, '', ''),
(49, 30, 'social_youtube_url', 'Liên kết đến trang Youtube', '', 'text', '', '', '', 2, '', ''),
(50, 30, 'social_hr_2', 'social_hr_2', '', 'separator', '', '', '', 3, '', ''),
(51, 19, 'general_search_list', 'Từ khóa hay tìm kiếm', 'Các từ khóa cách nhau bằng dấu ,', 'textarea', '', '', 'quần áo,điện thoại', 4, '', '');
...
CREATE TABLE `slider` (
  ...
  `url` varchar(255) NOT NULL,
  `sort` int(11) NOT NULL DEFAULT '0',
  `is_feature` enum('yes','no') NOT NULL DEFAULT 'no',
  `display` enum('show','hide') NOT NULL DEFAULT 'hide',
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
(2, 'kI4ca9qEjX_syJ79hL-gYyz-n3Q3zwVe', 1522061671, 0);
...
INSERT INTO `user` (`id`, `role_id`, `username`, `email`, `unconfirmed_email`, `password_hash`, `auth_key`, `registration_ip`, `flags`, `confirmed_at`, `blocked_at`, `last_login_at`, `created_at`, `updated_at`) VALUES
(1, 1, 'admin', 'admin@admin.com', NULL, '$2y$13$vJ15TvstvBhKMeTa0/gAkOWt7AUx.BxhxrP2.dgwjZ40vN.8nFGV2', '', NULL, 0, NULL, NULL, 1522133963, 0, 0),
(2, 1, 'phuong17889@gmail.com', 'phuong17889@gmail.com', NULL, '$2y$10$dMoc/HYy/fdQJ73uLDrAB.5wfwdB0OQNi5u8VGd8kwpx3FRa9DapO', 'DrVjWU3tjKBoAp_94JKbSSRRHJOxJZ6x', '127.0.0.1', 0, NULL, NULL, 1522132165, 1522061671, 1522061671);
...
--
-- Indexes for table `auction_order`
--
...
ALTER TABLE `category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_NK1` (`root`),
  ADD KEY `category_NK2` (`lft`),
  ADD KEY `category_NK3` (`rgt`),
  ADD KEY `category_NK4` (`lvl`),
  ADD KEY `category_NK5` (`active`);
...
--
-- Indexes for table `eav_attribute_rules`
--
...
--
-- Indexes for table `eav_attribute_type`
--
ALTER TABLE `eav_attribute_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eav_attribute_value`
--
...
ALTER TABLE `email_template`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `shortcut` (`shortcut`,`language`);
...
ALTER TABLE `product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `eav_entity_id` (`eav_entity_id`);

--
-- Indexes for table `product_auction_proposal`
--
ALTER TABLE `product_auction_proposal`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `product_id` (`product_id`);
...
--
-- AUTO_INCREMENT for table `auction_order`
--
ALTER TABLE `auction_order`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `eav_attribute_rules`
--
ALTER TABLE `eav_attribute_rules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `eav_attribute_type`
--
ALTER TABLE `eav_attribute_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `eav_attribute_value`
--
ALTER TABLE `eav_attribute_value`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `product_auction_proposal`
--
ALTER TABLE `product_auction_proposal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `auction_history`
  ADD CONSTRAINT `auction_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `auction_history_ibfk_2` FOREIGN KEY (`auction_id`) REFERENCES `auction` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `auction_order`
--
ALTER TABLE `auction_order`
  ADD CONSTRAINT `auction_order_ibfk_1` FOREIGN KEY (`auction_id`) REFERENCES `auction` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `auction_order_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `district`
--
ALTER TABLE `district`
  ADD CONSTRAINT `fk_district_province_id` FOREIGN KEY (`province_id`) REFERENCES `province` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `eav_attribute_rules`
--
ALTER TABLE `eav_attribute_rules`
...
--
-- Constraints for table `eav_attribute_value`
--
ALTER TABLE `eav_attribute_value`
...
ALTER TABLE `order_detail`
  ...
  ADD CONSTRAINT `order_detail_ibfk_2` FOREIGN KEY (`product_detail_id`) REFERENCES `product_detail` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`eav_entity_id`) REFERENCES `eav_entity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `product_auction_proposal`
--
ALTER TABLE `product_auction_proposal`
  ADD CONSTRAINT `product_auction_proposal_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `product_auction_proposal_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `user_address`
  ...
  ADD CONSTRAINT `user_address_ibfk_2` FOREIGN KEY (`district_id`) REFERENCES `district` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
